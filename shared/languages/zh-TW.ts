export const ZH_TW = {
   ...
   CologneCathedralDesc:
      "建造完成時，產生一次性科技值，相當於當前時代最昂貴技術的成本。所有生產科學的建築（不包括複製實驗室）獲得 +1 生產倍數。此奇觀可升級，每次升級額外提供 +1 生產倍數給所有生產科學的建築（不包括複製實驗室）",
   Colonialism: "種族",
   Colosseum: "羅馬競技場",
   ...
   Warp: "扭曲時間",
   WarpConversionDesc: "超過最大離線生產時間的離線時間，將被轉化為扭曲時間。(1秒 = 1扭曲時間)",
   Water: "水",
